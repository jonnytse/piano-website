    ...
    render() {
        return (
            <div className={styles.about}>
                ...
                <iframe title="BBC Young Musician 2020 Strings Final Highlights" width="504" height="283" src="https://www.youtube.com/embed/oyvklLQ-DU8?start=333" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        )
    }
}
